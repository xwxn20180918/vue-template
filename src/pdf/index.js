...
const Print = function (dom, options) {
    ...
    this.init(options.filename);
  };
  Print.prototype = {
    init: function (filename) {
      var content = this.getStyle() + this.getHtml();
      this.writeIframe(content, filename);
    },
    ...
    writeIframe: function (content, filename) {
    ...
    toPrint: function (frameWindow, filename) {
